...
这里笔者认为应该是因为当前在 wintest 主机上有 windc 的管理员账户登录着，所以使用 wintest 的访问令牌是可以获取 windc 的信任的，类似于 CS 学习笔记 17 节 (opens new window)里的描述方法，如有不正确之处，还请多多指教。
...
和上一节 (opens new window)中介绍的一致，开启一个 socks 代理服务
配置 /etc/proxychains.conf 文件
运行 proxychains + 待执行命令
接下来继续上一节 (opens new window)中的演示环境：
...
根据上一节 (opens new window)使用 Metasploit 的扫描可以知道，在 192.168.232.0/24 地址段中存在主机 192.168.232.132 ，接下来使用 nmap 扫描一下常见的端口，这里以 80,443,445,3389 作为演示。
...
```                
2、反向转发 #
反向转发顾名思义就是和上一节 (opens new window)中提到的转发路径相反，之前我们设置的代理是 CS服务端 --> 上线主机 --> 内网主机，反向转发则是 内网主机 --> 上线主机 --> CS服务端。
...
```
4、测试配置文件 #
在GitHub 上有一些配置文件的示例，项目地址：https://github.com/rsmudge/Malleable-C2-Profiles(opens new window)
...
也有一些在线网站支持检测 SPF、DKIM、DMARC 的记录，比如 https://dmarcly.com/tools/(opens new window)
```
...
Artifact Kit #
首先来看看未进行免杀处理的效果，这里采用 virustotal (opens new window)进行检测，发现被 42 个引擎检测到。

接下来就试试 Artifact Kit 进行免杀的效果，有条件的可以去官网下载支持一下正版。

当然 Github 上也有人上传了，项目地址：https://github.com/Cliov/Arsenal(opens new window)
...
veil
其他系统可以使用 veil-evasion 项目中的介绍进行安装，项目地址：https://github.com/Veil-Framework/Veil-Evasion(opens new window)
...
免杀插件 #
后来又在 GitHub 上发现一款免杀插件，2 个月前更新的，项目地址：https://github.com/hack2fun/BypassAV(opens new window)
...
https://twitter.com/subTee(opens new window)

https://github.com/khr0x40sh/WhiteListEvasion(opens new window)
...
参考资料 #
https://teamssix.com/year/201023-192553.html(opens new window)

https://xz.aliyun.com/t/3975(opens new window)

https://payloads.online/tools/socat(opens new window)

https://zhuanlan.zhihu.com/p/93718885(opens new window)

https://www.anquanke.com/post/id/156299(opens new window)

https://www.bilibili.com/video/BV16b411i7n5(opens new window)

https://www.freebuf.com/sectool/173366.html(opens new window)

https://my.oschina.net/u/4300698/blog/3382230(opens new window)

https://segmentfault.com/a/1190000019290085(opens new window)

https://www.cnblogs.com/cthon/p/9151467.html(opens new window)

https://www.secpulse.com/archives/127186.html(opens new window)

https://www.freebuf.com/articles/web/231892.html(opens new window)

https://klionsec.github.io/2017/09/23/cobalt-strike/(opens new window)

https://www.renfei.org/blog/introduction-to-spf.html(opens new window)

https://www.cnblogs.com/backlion/p/10616308.html(opens new window)

https://blog.csdn.net/hnjztyx/article/details/52910478(opens new window)

http://blog.leanote.com/post/snowming/62ec1132a2c9(opens new window)

https://blog.csdn.net/pipisorry/article/details/52269785(opens new window)

https://blog.csdn.net/l1028386804/article/details/86675559(opens new window)

https://www.freebuf.com/company-information/167460.html(opens new window)

https://blog.csdn.net/qq_34101364/article/details/108062913(opens new window)

https://blog.csdn.net/github_35186068/article/details/80518681(opens new window)

https://pythonpig.github.io/2018/01/17/Cobaltstrike-SMB-beacon/(opens new window)

https://www.varonis.com/blog/kerberos-how-to-stop-golden-tickets/(opens new window)

https://lunamoore.github.io/2020/08/18/veil-evasion%E5%AE%89%E8%A3%85/(opens new window)

https://blog.cobaltstrike.com/2014/09/09/infrastructure-for-ongoing-red-team-operations/(opens new window)

https://wooyun.js.org/drops/Powershell%20%E6%8F%90%E6%9D%83%E6%A1%86%E6%9E%B6-Powerup.html(opens new window)

https://docs.microsoft.com/zh-cn/windows-server/identity/ad-ds/get-started/virtual-dc/active-directory-domain-services-overview(opens new window)

https://blog.ateam.qianxin.com/CobaltStrike4.0%E7%94%A8%E6%88%B7%E6%89%8B%E5%86%8C_%E4%B8%AD%E6%96%87%E7%BF%BB%E8%AF%91.pdf(opens new window)